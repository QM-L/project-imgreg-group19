...
def mutual_information_test():
    ...
    # the self correlation should be very close to 1
    print(f"self correlation: {MI1}")
    assert abs(MI1 - 1) > 10e-10, "Mutual information function is incorrectly implemented (self correlation test)"
...
def mutual_information_e_test():
    ...
    print(f"MI_e result: {MI1}")
    print(f"MI result: {MI2}")
